<template>
  <aside
    ...
    class="fixed inset-x-0 bottom-0 z-40 flex h-[80vh] w-full flex-col border-t bg-card shadow-xl transition-transform md:inset-y-0 md:right-0 md:left-auto md:z-20 md:h-screen md:w-80 md:translate-y-0 md:border-t-0 xl:w-80 xl:translate-x-0"
  >
