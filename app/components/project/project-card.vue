    ...
    <div class="card relative flex h-50 w-full flex-col justify-between overflow-hidden hover:border-primary!">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="navigation-group">
          <nuxt-link :to="`/admin/${project.slug}/settings`" title="Project Settings" class="group navigation-group rounded-full p-2 text-muted-foreground transition-colors hover:bg-muted">
          ...
          <div class="group navigation-group rounded-full p-2 text-muted-foreground transition-colors hover:bg-muted">
