    ...
    <div class="card group relative flex h-50 w-full flex-col justify-between overflow-hidden">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="navigation-group">
          <nuxt-link :to="`/admin/${project.slug}/settings`" title="Project Settings" class="navigation-group rounded-full p-2 text-muted-foreground hover:bg-muted">
            <icon name="ph:gear" size="25" class="transition-transform hover:scale-110 hover:text-primary" />
          ...
          <div class="group navigation-group rounded-full p-2 text-muted-foreground hover:bg-muted">
            ...
            <icon name="ph:arrow-right" size="25" class="transition-transform group-hover:scale-110 group-hover:text-primary" />
          </div>
        </div>
      </div>
    </div>
