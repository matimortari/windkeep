<template>
  <TabSection title="Settings" description="Manage organization details and settings.">
    <div class="flex flex-col">
      <div v-for="(field, index) in orgFields" :key="index" class="flex flex-col justify-between gap-4 border-b py-2 last:border-b-0 md:navigation-group">
    ...
    <div v-if="isOwner" class="flex flex-col justify-between gap-4 border-t pt-6 md:navigation-group" aria-label="Organization encryption settings">
