const INDEX_CONTENT: CliSection[] = [
  {
    ...
    note: ["You can use ", { code: "wk" }, " as a shortcut for ", { code: "windkeep" }, "."],
  },
  {
    title: "Quick Installation",
    paragraphs: [["Run the install script for your platform. It downloads the binary and updates your PATH."]],
    code: [
    ...
    note: ["Restart your terminal after installing, then run ", { code: "windkeep --version" }, " to verify."],
  },
  {
    ...
    code: [{ command: "go install github.com/matimortari/windkeep/cli@latest" }],
    note: ["This method does not set up the ", { code: "wk" }, " shortcut."],
  },
  {
    ...
    note: ["Login validates your token and saves credentials to ", { code: "~/.config/windkeep/config.yml" }, " (Linux) or ", { code: "%APPDATA%\\windkeep\\config.yml" }, " (Windows)."],
    code: [{
      command: [
